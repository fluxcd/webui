...
type Decryption struct {
	...
	SecretRef *ObjectRef `protobuf:"bytes,2,opt,name=secret_ref,json=secretRef,proto3" json:"secret_ref,omitempty"`
}
...
func (x *Decryption) GetSecretRef() *ObjectRef {
	if x != nil {
		return x.SecretRef
	}
	return nil
...
type Kustomization struct {
	...
	Namespace string `protobuf:"bytes,2,opt,name=namespace,proto3" json:"namespace,omitempty"`
	// spec
	DependsOn          []*ObjectRef `protobuf:"bytes,3,rep,name=depends_on,json=dependsOn,proto3" json:"depends_on,omitempty"`
	Decryption         *Decryption  `protobuf:"bytes,4,opt,name=decryption,proto3" json:"decryption,omitempty"`
	...
	HealthChecks       []*ObjectRef `protobuf:"bytes,9,rep,name=health_checks,json=healthChecks,proto3" json:"health_checks,omitempty"`
	...
	SourceRef          *ObjectRef   `protobuf:"bytes,11,opt,name=source_ref,json=sourceRef,proto3" json:"source_ref,omitempty"`
	Suspend            bool         `protobuf:"varint,12,opt,name=suspend,proto3" json:"suspend,omitempty"`
	...
	// status
	Conditions         []*Condition `protobuf:"bytes,15,rep,name=conditions,proto3" json:"conditions,omitempty"`
	ReconcileRequestAt string       `protobuf:"bytes,16,opt,name=reconcile_request_at,json=reconcileRequestAt,proto3" json:"reconcile_request_at,omitempty"`
	ReconciledAt       string       `protobuf:"bytes,17,opt,name=reconciled_at,json=reconciledAt,proto3" json:"reconciled_at,omitempty"`
}
...
func (x *Kustomization) GetDependsOn() []*ObjectRef {
	if x != nil {
		return x.DependsOn
	}
	return nil
...
func (x *Kustomization) GetDecryption() *Decryption {
	if x != nil {
		return x.Decryption
	}
	return nil
...
func (x *Kustomization) GetKubeconfig() string {
	if x != nil {
		return x.Kubeconfig
	}
	return ""
...
func (x *Kustomization) GetHealthChecks() []*ObjectRef {
	if x != nil {
...
func (x *Kustomization) GetServiceAccountName() string {
	if x != nil {
...
func (x *Kustomization) GetSourceRef() *ObjectRef {
	if x != nil {
		return x.SourceRef
	}
	return nil
...
func (x *Kustomization) GetSuspend() bool {
	if x != nil {
		return x.Suspend
	}
	return false
...
func (x *Kustomization) GetTimeout() string {
	if x != nil {
		return x.Timeout
	}
	return ""
...
func (x *Kustomization) GetReconciledAt() string {
	if x != nil {
...
type Artifact struct {
	...
	LastUpdatedAt int32  `protobuf:"varint,2,opt,name=last_updated_at,json=lastUpdatedAt,proto3" json:"last_updated_at,omitempty"`
...
func (x *Artifact) GetLastUpdatedAt() int32 {
	if x != nil {
...
type Source struct {
	...
	GitImplementation string            `protobuf:"bytes,9,opt,name=git_implementation,json=gitImplementation,proto3" json:"git_implementation,omitempty"`
	Timeout           string            `protobuf:"bytes,10,opt,name=timeout,proto3" json:"timeout,omitempty"`
	SecretRefName     string            `protobuf:"bytes,11,opt,name=secret_ref_name,json=secretRefName,proto3" json:"secret_ref_name,omitempty"`
...
type ListSourcesReq struct {
	...
	ContextName string      `protobuf:"bytes,1,opt,name=context_name,json=contextName,proto3" json:"context_name,omitempty"`
	Namespace   string      `protobuf:"bytes,2,opt,name=namespace,proto3" json:"namespace,omitempty"`
	SourceType  Source_Type `protobuf:"varint,3,opt,name=source_type,json=sourceType,proto3,enum=clusters.Source_Type" json:"source_type,omitempty"`
}
...
type SyncKustomizationReq struct {
	...
	WithSource        bool   `protobuf:"varint,4,opt,name=with_source,json=withSource,proto3" json:"with_source,omitempty"`
}
...
type HelmRelease struct {
	...
	SourceNamespace string       `protobuf:"bytes,9,opt,name=source_namespace,json=sourceNamespace,proto3" json:"source_namespace,omitempty"`
	Conditions      []*Condition `protobuf:"bytes,12,rep,name=conditions,proto3" json:"conditions,omitempty"`
}
...
type Workload struct {
	...
	Name                      string       `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Namespace                 string       `protobuf:"bytes,2,opt,name=namespace,proto3" json:"namespace,omitempty"`
	KustomizationRefName      string       `protobuf:"bytes,3,opt,name=kustomization_ref_name,json=kustomizationRefName,proto3" json:"kustomization_ref_name,omitempty"`
	KustomizationRefNamespace string       `protobuf:"bytes,4,opt,name=kustomization_ref_namespace,json=kustomizationRefNamespace,proto3" json:"kustomization_ref_namespace,omitempty"`
	PodTemplate               *PodTemplate `protobuf:"bytes,5,opt,name=pod_template,json=podTemplate,proto3" json:"pod_template,omitempty"`
}
...
type ListKustomizationChildrenReq struct {
	...
	ContextName            string `protobuf:"bytes,1,opt,name=context_name,json=contextName,proto3" json:"context_name,omitempty"`
	KustomizationName      string `protobuf:"bytes,2,opt,name=kustomization_name,json=kustomizationName,proto3" json:"kustomization_name,omitempty"`
	KustomizationNamespace string `protobuf:"bytes,3,opt,name=kustomization_namespace,json=kustomizationNamespace,proto3" json:"kustomization_namespace,omitempty"`
}
...
var file_pkg_rpc_clusters_clusters_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x73, 0x52, 0x65, 0x71, 0x22, 0x69, 0x0a,
	...
	,
	...
	0x6d, 0x70, 0x22, 0x72, 0x0a, 0x09, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x66, 0x12,
	...
	0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0x5c, 0x0a, 0x0a, 0x44, 0x65, 0x63, 0x72, 0x79, 0x70,
	...
	0x12, 0x32, 0x0a, 0x0a, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x5f, 0x72, 0x65, 0x66, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x2e,
	0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x66, 0x52, 0x09, 0x73, 0x65, 0x63, 0x72, 0x65,
	0x74, 0x52, 0x65, 0x66, 0x22, 0x9c, 0x05, 0x0a, 0x0d, 0x4b, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69,
	...
	,
	...
	,
	...
	0x15, 0x4c, 0x69, 0x73, 0x74, 0x4b, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x12, 0x3f, 0x0a, 0x0e, 0x6b, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x8e, 0x04, 0x0a, 0x06, 0x53, 0x6f, 0x75,
	...
	0x52, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x75,
	0x63, 0x6b, 0x65, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xb6, 0x02, 0x0a, 0x0b, 0x48, 0x65, 0x6c, 0x6d, 0x52, 0x65, 0x6c,
	...
	0x61, 0x6c, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x68, 0x61, 0x72, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x68, 0x61, 0x72, 0x74, 0x4e, 0x61, 0x6d,
	0x65, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	...
	0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4e,
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x33, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x64,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x63,
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x2e, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x56, 0x0a,
	0x13, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x65, 0x6c, 0x6d, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65,
	0x73, 0x52, 0x65, 0x71, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x5f,
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x51, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x65, 0x6c,
	0x6d, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x73, 0x52, 0x65, 0x73, 0x12, 0x3a, 0x0a, 0x0d,
	0x68, 0x65, 0x6c, 0x6d, 0x5f, 0x72, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x2e, 0x48,
	0x65, 0x6c, 0x6d, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x52, 0x0c, 0x68, 0x65, 0x6c, 0x6d,
	0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x73, 0x22, 0x35, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x74,
	...
	0x42, 0x0a, 0x0b, 0x50, 0x6f, 0x64, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x33,
	...
	,
	...
	0x61, 0x64, 0x52, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x22, 0xa9, 0x01,
	0x0a, 0x1c, 0x4c, 0x69, 0x73, 0x74, 0x4b, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x21,
	0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	...
	0x6f, 0x6e, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x6b,
	...
	,
	...
	0x65, 0x22, 0x50, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52,
	0x65, 0x71, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x5f, 0x6e, 0x61,
	...
	0x61, 0x63, 0x65, 0x22, 0x38, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x73, 0x52, 0x65, 0x73, 0x12, 0x27, 0x0a, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x2e,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x32, 0x85, 0x05,
	...
	0x12, 0x68, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63,
	0x65, 0x73, 0x46, 0x6f, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x12, 0x25, 0x2e, 0x63,
	...
	,
}
...
var file_pkg_rpc_clusters_clusters_proto_goTypes = []interface{}{
	...
	(*ObjectRef)(nil),                    // 7: clusters.ObjectRef
	(*Decryption)(nil),                   // 8: clusters.Decryption
...
var file_pkg_rpc_clusters_clusters_proto_depIdxs = []int32{
	...
	7,  // 1: clusters.Decryption.secret_ref:type_name -> clusters.ObjectRef
	7,  // 2: clusters.Kustomization.depends_on:type_name -> clusters.ObjectRef
	8,  // 3: clusters.Kustomization.decryption:type_name -> clusters.Decryption
	7,  // 4: clusters.Kustomization.health_checks:type_name -> clusters.ObjectRef
	7,  // 5: clusters.Kustomization.source_ref:type_name -> clusters.ObjectRef
	6,  // 6: clusters.Kustomization.conditions:type_name -> clusters.Condition
	9,  // 7: clusters.ListKustomizationsRes.kustomizations:type_name -> clusters.Kustomization
	12, // 8: clusters.Source.reference:type_name -> clusters.GitRepositoryRef
	0,  // 9: clusters.Source.type:type_name -> clusters.Source.Type
	6,  // 10: clusters.Source.conditions:type_name -> clusters.Condition
	13, // 11: clusters.Source.artifact:type_name -> clusters.Artifact
	0,  // 12: clusters.ListSourcesReq.source_type:type_name -> clusters.Source.Type
	14, // 13: clusters.ListSourcesRes.sources:type_name -> clusters.Source
	...
	19, // 16: clusters.ListHelmReleasesRes.helm_releases:type_name -> clusters.HelmRelease
	22, // 17: clusters.PodTemplate.containers:type_name -> clusters.Container
	23, // 18: clusters.Workload.pod_template:type_name -> clusters.PodTemplate
	24, // 19: clusters.ListWorkloadsRes.workloads:type_name -> clusters.Workload
	24, // 20: clusters.ListKustomizationChildrenRes.workloads:type_name -> clusters.Workload
	29, // 21: clusters.ListEventsRes.events:type_name -> clusters.Event
	2,  // 22: clusters.Clusters.ListContexts:input_type -> clusters.ListContextsReq
	4,  // 23: clusters.Clusters.ListNamespacesForContext:input_type -> clusters.ListNamespacesForContextReq
	10, // 24: clusters.Clusters.ListKustomizations:input_type -> clusters.ListKustomizationsReq
	15, // 25: clusters.Clusters.ListSources:input_type -> clusters.ListSourcesReq
	17, // 26: clusters.Clusters.SyncKustomization:input_type -> clusters.SyncKustomizationReq
	20, // 27: clusters.Clusters.ListHelmReleases:input_type -> clusters.ListHelmReleasesReq
	25, // 28: clusters.Clusters.ListWorkloads:input_type -> clusters.ListWorkloadsReq
	30, // 29: clusters.Clusters.ListEvents:input_type -> clusters.ListEventsReq
	3,  // 30: clusters.Clusters.ListContexts:output_type -> clusters.ListContextsRes
	5,  // 31: clusters.Clusters.ListNamespacesForContext:output_type -> clusters.ListNamespacesForContextRes
	11, // 32: clusters.Clusters.ListKustomizations:output_type -> clusters.ListKustomizationsRes
	16, // 33: clusters.Clusters.ListSources:output_type -> clusters.ListSourcesRes
	18, // 34: clusters.Clusters.SyncKustomization:output_type -> clusters.SyncKustomizationRes
	21, // 35: clusters.Clusters.ListHelmReleases:output_type -> clusters.ListHelmReleasesRes
	26, // 36: clusters.Clusters.ListWorkloads:output_type -> clusters.ListWorkloadsRes
	31, // 37: clusters.Clusters.ListEvents:output_type -> clusters.ListEventsRes
